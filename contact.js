...
const Contact = ({navigation}) => {
    ...
    <SimpleLineIcons style={styles.menuIcon}name="menu" size={25}  backgroundColor="#fff" color="purple" onPress={()=>navigation.openDrawer()}/><SimpleLineIcons/>
    <AntDesign style={styles.editProfile}name="edit" size={25}  backgroundColor="#fff" color="purple" onPress={()=>navigation.navigate("Contact3")}/><AntDesign/>
      <View style={styles.userInfoSection}>
        <View style={{flexDirection: 'row', marginTop: 30,marginRight:1}}>
        <Avatar.Image  source={{uri:'https://www.w3schools.com/w3images/avatar2.png'}}
        size={85}/>
       ...
       <View style={styles.userInfoSection2}>
         ...
         <Icon name="map-marker-radius" size={20} color="purple"   />
           <Text style={{color:"#777777", marginLeft: 8}} >Islamabad,Pakistan</Text>
         </View>
         <View>  
         <View style={styles.row}>
          <Icon name="email" color="purple" size={20}/>
          <Text style={{color:"#777777", marginLeft: 10}}>faiz337@email.com</Text>
        </View>
        <View style={styles.row}>
